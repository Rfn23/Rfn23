...
for xd in range(10000):
    ...
    b=random.choice(['5.0','6.0','7.0','8.0','9.0','10.0','11.0','12.0'])
    c='Infinix X682C)'
    ...
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/537.36 hola_android'
    uaku2=f'{aa}; {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
    ugen.append(uaku2)
    ...
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9.0.1','10.0.1','11.0.1','12.0.1'])
    c='Redmi 6A)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
    e=random.randrange(73,100)
    f='0'
...
#User Agnes buatan Asep Yusup 
    ...
    tiga  = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; 4188S Build/SP1A.{str(rr(100000,200000))}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) {str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Version/4.0 Chrome/{str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Mobile Safari/537.36"
